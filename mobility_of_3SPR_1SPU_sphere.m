...
mechanism(2) = struct('matrix', ...
    [mmc_revolute_joint(leg_outer_end_coordinates(:, 1) - leg_outer_end_coordinates(:, 3), leg_inner_end_coordinates(:, 2)), ...
     mmc_prismatic_joint(leg_axes(:, 2)), ...
     mmc_spherical_joint(leg_outer_end_coordinates(:, 2))]);
mechanism(3) = struct('matrix', ...
    [mmc_revolute_joint(leg_outer_end_coordinates(:, 2) - leg_outer_end_coordinates(:, 1), leg_inner_end_coordinates(:, 3)), ...
